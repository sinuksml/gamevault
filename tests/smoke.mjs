...
assert.match(js,/function gameReleaseMeta\s*\(/,"Games Upcoming must keep its release-date countdown renderer");
assert.match(js,/gameTile\(g,g\.id,g\.date\?esc\(fmt\(g\.date\)\):"Date TBC",gameReleaseMeta\(g\)\)/,"Games grid must show the color-coded release countdown");
