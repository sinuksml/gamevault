...
const WORKER_VERSION = "github-v8";
...
function schedulePolling(){stopPolling();if(auto&&token&&!document.hidden)timer=setTimeout(async function(){await load();schedulePolling()},2000)}
